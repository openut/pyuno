 ...
 *
 * @ORM\Table(name="ctl_tipo_establecimiento", indexes={@ORM\Index(name="IDX_3CDCBB53EF433A34", columns={"id_institucion"}), @ORM\Index(name="IDX_3CDCBB53735E702C", columns={"id_usuario_mod"}), @ORM\Index(name="IDX_3CDCBB537C22D51", columns={"id_usuario_reg"})})
 * @ORM\Entity
 */
