 ...
 *
 * @ORM\Table(name="ctl_proyecto_financiamiento", indexes={@ORM\Index(name="IDX_FE1C731F735E702C", columns={"id_usuario_mod"}), @ORM\Index(name="IDX_FE1C731F7C22D51", columns={"id_usuario_reg"})})
 * @ORM\Entity
 */
